...
title: tenantstatistics
---
## c8y tenantstatistics

Cumulocity tenant statistics

### Synopsis

REST endpoint to interact with Cumulocity tenant statistics

### Options

```
  -h, --help   help for tenantstatistics
```
