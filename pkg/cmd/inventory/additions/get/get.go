// v2-based inventory additions get (deprecated; use `inventory children get
// --childType addition`): fetches a single child-addition reference from a parent
// (resolved as a managed object) and returns the referenced managed object. The
// id flag drives iteration.
package get
...
// NewGetCmd creates a command to Get child addition
func NewGetCmd(f *cmdutil.Factory) *GetCmd {
	...
	cmd := &cobra.Command{
		Use:   "get",
		Short: "Get child addition",
		Long:  `Get managed object child addition`,
		Example: heredoc.Doc(`
$ c8y inventory additions get --id 12345 --child 12345
Get an existing child addition reference
	...
	flags.WithOptions(
		...
		flags.WithPowershellName("Get-ChildAddition"),
...
func (n *GetCmd) RunE(cmd *cobra.Command, args []string) error {
	...
	return r.Run(func(in *c8ystream.Resolver) (c8ystream.Call, error) {
		...
		return func(ctx context.Context) output.Seq {
			return c8ystream.FromResult(client.ManagedObjects.ChildAdditions.Get(ctx, parentID, childID))
		}, nil
	})
}
