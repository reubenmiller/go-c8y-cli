// v2-based inventory children list: the id flag drives iteration; each parent
...
// service (reusing the device-groups childref dispatcher), plucking the nested
// managed objects.
package list
...
Get a list of the child devices of an existing managed object
	...
	flags.WithOptions(
		...
		flags.WithPowershellName("Get-ManagedObjectChildCollection"),
