// v2-based device registration get: the id flag drives iteration (pipe or --id);
// each device request id (the device's external id, used as-is — no name
// resolution) is fetched via Devices.Registration.Get.
package get
...
Get a new device request
	...
	flags.WithOptions(
		...
		flags.WithPowershellName("Get-DeviceRequest"),
...
func (n *GetCmd) RunE(cmd *cobra.Command, args []string) error {
	...
	return r.Run(func(in *c8ystream.Resolver) (c8ystream.Call, error) {
		...
		return func(ctx context.Context) output.Seq {
			return c8ystream.FromResult(client.Devices.Registration.Get(ctx, id))
		}, nil
	})
}
