...
// UpdateOperationCmd command
type UpdateOperationCmd struct {
	*baseCmd
}

// NewUpdateOperationCmd creates a command to Update operation
...
func (n *UpdateOperationCmd) RunE(cmd *cobra.Command, args []string) error {
	var err error
