// v2-based retention rules delete: the id flag drives iteration (pipe or --id
// slice); each rule is deleted via RetentionRules.Delete. Success yields no
...
Delete a retention rule
	...
	flags.WithOptions(
		...
		flags.WithPowershellName("Remove-RetentionRule"),
	)
	...
	return r.Run(func(in *c8ystream.Resolver) (c8ystream.Call, error) {
		...
		return func(ctx context.Context) output.Seq {
			return c8ystream.SubmitStatus(ctx, func(ctx context.Context) op.Result[core.NoContent] {
				return client.RetentionRules.Delete(ctx, id)
			})
		}, nil
	})
}
