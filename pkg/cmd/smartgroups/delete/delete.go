// v2-based smart group delete: the id flag drives iteration (pipe or --id); each
// smart-group reference (id or name, resolved scoped to smart groups) is deleted
// via SmartGroups.Delete. Deleting a smart group does not affect its devices.
...
Delete a smart group by id
	...
	flags.WithOptions(
		...
		flags.WithPowershellName("Remove-SmartGroup"),
	)
	...
	return r.Run(func(in *c8ystream.Resolver) (c8ystream.Call, error) {
		...
		return func(ctx context.Context) output.Seq {
			return c8ystream.SubmitStatus(ctx, func(ctx context.Context) op.Result[core.NoContent] {
				return client.SmartGroups.Delete(ctx, ref, smartgroups.DeleteOptions{})
			})
		}, nil
	})
}
