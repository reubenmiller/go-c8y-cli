// v2-based smart group get: the id flag drives iteration (pipe or --id); each
// smart-group reference (id or name, resolved scoped to smart groups) is fetched
// via SmartGroups.Get.
package get
...
func NewGetCmd(f *cmdutil.Factory) *GetCmd {
	...
	cmd := &cobra.Command{
		...
		Long:  `Get a smart group`,
		Example: heredoc.Doc(`
$ c8y smartgroups get --id 12345
Get a smart group by id

$ c8y smartgroups get --id mygroup
Get a smart group by name
        `),
	...
	flags.WithOptions(
		...
		flags.WithPowershellName("Get-SmartGroup"),
...
func (n *GetCmd) RunE(cmd *cobra.Command, args []string) error {
	...
	return r.Run(func(in *c8ystream.Resolver) (c8ystream.Call, error) {
		...
		return func(ctx context.Context) output.Seq {
			return c8ystream.FromResult(client.SmartGroups.Get(ctx, ref, opt))
		}, nil
	})
}
