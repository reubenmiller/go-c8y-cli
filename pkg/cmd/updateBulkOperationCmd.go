...
Update an bulk operation
	...
	cmd.Flags().Int("creationRampSec", 0, "Delay between every operation creation.")
	addDataFlag(cmd)
...
func (n *updateBulkOperationCmd) updateBulkOperation(cmd *cobra.Command, args []string) error {
	...
	return n.doUpdateBulkOperation(req, outputfile, filters)
}

func (n *updateBulkOperationCmd) doUpdateBulkOperation(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
