...
// GetChildDeviceCmd command
type GetChildDeviceCmd struct {
	*subcommand.SubCommand

	factory *cmdutil.Factory
}

// NewGetChildDeviceCmd creates a command to Get child device reference
func NewGetChildDeviceCmd(f *cmdutil.Factory) *GetChildDeviceCmd {
	ccmd := &GetChildDeviceCmd{
		factory: f,
	}
	cmd := &cobra.Command{
		Use:   "getChildDevice",
...
func (n *GetChildDeviceCmd) RunE(cmd *cobra.Command, args []string) error {
