...
// ListChildAdditionsCmd command
type ListChildAdditionsCmd struct {
...
// NewListChildAdditionsCmd creates a command to Get child addition collection
func NewListChildAdditionsCmd(f *cmdutil.Factory) *ListChildAdditionsCmd {
	ccmd := &ListChildAdditionsCmd{
		factory: f,
		Config:  f.Config,
		Client:  f.Client,
	}
...
func (n *ListChildAdditionsCmd) RunE(cmd *cobra.Command, args []string) error {
	cfg, err := n.Config()
	if err != nil {
		return err
	}
