...
// UnassignChildAdditionCmd command
type UnassignChildAdditionCmd struct {
	*subcommand.SubCommand

	factory *cmdutil.Factory
}

// NewUnassignChildAdditionCmd creates a command to Unassign child addition
func NewUnassignChildAdditionCmd(f *cmdutil.Factory) *UnassignChildAdditionCmd {
	ccmd := &UnassignChildAdditionCmd{
		factory: f,
	}
	cmd := &cobra.Command{
...
func (n *UnassignChildAdditionCmd) RunE(cmd *cobra.Command, args []string) error {
