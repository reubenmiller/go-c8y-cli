...
package unassigndevicefromgroup
...
// UnassignDeviceFromGroupCmd command
type UnassignDeviceFromGroupCmd struct {
	*subcommand.SubCommand

	factory *cmdutil.Factory
}

// NewUnassignDeviceFromGroupCmd creates a command to Unassign device from group
func NewUnassignDeviceFromGroupCmd(f *cmdutil.Factory) *UnassignDeviceFromGroupCmd {
	ccmd := &UnassignDeviceFromGroupCmd{
		factory: f,
	}
	cmd := &cobra.Command{
...
func (n *UnassignDeviceFromGroupCmd) RunE(cmd *cobra.Command, args []string) error {
