...
// NewFindCmd creates a command to Get a specific version of an application
func NewFindCmd(f *cmdutil.Factory) *FindCmd {
	...
	cmd := &cobra.Command{
		...
		Example: heredoc.Doc(`
$ c8y applications versions find --id 1234 --tag tag1
Get application version by tag

$ c8y applications versions find --id 1234 --version 1.0
