// v2-based notification2 subscription delete: the id (subscription id) drives
// iteration and is passed straight through to Notification2.Delete.
package delete
...
Delete all subscriptions which share the same subscription name (using client side filtering)
	...
	flags.WithOptions(
		...
		flags.WithPowershellName("Remove-Notification2Subscription"),
	)
	...
	return r.Run(func(in *c8ystream.Resolver) (c8ystream.Call, error) {
		...
		return func(ctx context.Context) output.Seq {
			return c8ystream.SubmitStatus(ctx, func(ctx context.Context) op.Result[core.NoContent] {
				return client.Notification2.Delete(ctx, id)
			})
		}, nil
	})
}
