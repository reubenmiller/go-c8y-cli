...
// NewListCmd creates a command to Get child additions collection
func NewListCmd(f *cmdutil.Factory) *ListCmd {
	...
	cmd := &cobra.Command{
		Use:   "list",
		Short: "Get child additions collection",
		Long:  `Get a collection of managedObjects child additions`,
		Example: heredoc.Doc(`
$ c8y devicegroups additions list --group 12345
...
func (n *ListCmd) RunE(cmd *cobra.Command, args []string) error {
	...
	// path parameters
	path := flags.NewStringTemplate("inventory/managedObjects/{group}/childAdditions")
