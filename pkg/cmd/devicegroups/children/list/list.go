// v2-based device-group children list: the id flag drives iteration; each parent
// (resolved scoped to device groups) has its child references of the selected
...
Get a list of the child devices of an existing managed object
	...
	flags.WithOptions(
		...
		flags.WithPowershellName("Get-DeviceGroupChildCollection"),
