// v2-based device-group children get: fetches a single child reference of the
// selected --childType (addition|asset|device) from a parent (resolved scoped to
// device groups) and returns the referenced managed object. The id flag drives
// iteration.
package get
...
Get an existing child addition reference
	...
	flags.WithOptions(
		...
		flags.WithPowershellName("Get-DeviceGroupChild"),
