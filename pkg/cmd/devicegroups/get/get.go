// v2-based device group get: the id flag drives iteration (pipe or --id); each
// device-group reference (id or name, resolved scoped to device groups) is
// fetched via DeviceGroups.Get.
package get
...
Get device group by id
	...
	flags.WithOptions(
		...
		flags.WithPowershellName("Get-DeviceGroup"),
...
func (n *GetCmd) RunE(cmd *cobra.Command, args []string) error {
	...
	return r.Run(func(in *c8ystream.Resolver) (c8ystream.Call, error) {
		...
		return func(ctx context.Context) output.Seq {
			return c8ystream.FromResult(client.DeviceGroups.Get(ctx, ref, opt))
		}, nil
	})
}
