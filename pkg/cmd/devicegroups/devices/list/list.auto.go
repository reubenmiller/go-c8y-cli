...
// NewListCmd creates a command to Get child devices collection
func NewListCmd(f *cmdutil.Factory) *ListCmd {
	...
	cmd := &cobra.Command{
		Use:   "list",
		Short: "Get child devices collection",
		Long:  `Get a collection of managedObjects child devices`,
		Example: heredoc.Doc(`
$ c8y devicegroups devices list --group 12345
Get a list of the child devices of an existing device
	...
	cmd.Flags().StringSlice("group", []string{""}, "Device Group (required) (accepts pipeline)")
...
func (n *ListCmd) RunE(cmd *cobra.Command, args []string) error {
	...
	// path parameters
	path := flags.NewStringTemplate("inventory/managedObjects/{group}/childDevices")
