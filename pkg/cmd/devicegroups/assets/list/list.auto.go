...
// NewListCmd creates a command to Get child assets collection
func NewListCmd(f *cmdutil.Factory) *ListCmd {
	...
	cmd := &cobra.Command{
		Use:   "list",
		Short: "Get child assets collection",
		Long:  `Get a collection of managedObjects child assets`,
		Example: heredoc.Doc(`
$ c8y devicegroups assets list --group 12345
...
func (n *ListCmd) RunE(cmd *cobra.Command, args []string) error {
	...
	// path parameters
	path := flags.NewStringTemplate("inventory/managedObjects/{group}/childAssets")
