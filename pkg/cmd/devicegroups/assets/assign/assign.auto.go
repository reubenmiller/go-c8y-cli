...
func NewAssignCmd(f *cmdutil.Factory) *AssignCmd {
	...
	cmd := &cobra.Command{
		...
		Long:  `Assigns an asset to a group. The device will be a childAsset of the group`,
		Example: heredoc.Doc(`
$ c8y devicegroups assets assign --group 12345 --child 43234
Add a device to a group

$ c8y devicegroups assets assign --group 12345 --child 43234,99292,12222
