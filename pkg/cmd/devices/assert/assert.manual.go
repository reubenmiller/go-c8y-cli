...
import (
	cmdExists "github.com/reubenmiller/go-c8y-cli/pkg/cmd/devices/assert/exists"
	cmdFragments "github.com/reubenmiller/go-c8y-cli/pkg/cmd/devices/assert/fragments"
