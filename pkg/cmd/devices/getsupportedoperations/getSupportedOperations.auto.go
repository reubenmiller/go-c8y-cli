...
package getsupportedoperations
...
func NewGetSupportedOperationsCmd(f *cmdutil.Factory) *GetSupportedOperationsCmd {
...
Get the supported operations of a device by name
	...
	flags.WithOptions(
		...
		flags.WithCollectionProperty("c8y_SupportedOperations"),
	)
