// v2-based devices children create: creates a new managed object and links it as
// a child of the selected --childType (addition|asset|device) to a parent
...
Create a child addition and link it to an existing managed object
	...
	flags.WithOptions(
		...
		flags.WithPowershellName("New-DeviceChild"),
