// v2-based tenants applications disable: unsubscribes an application from a
// tenant via Tenants.UnsubscribeApplication. The application flag drives
// iteration (pipe or --application); the reference (id or name) is resolved to an
// id and used as the path parameter. The tenant defaults to the session tenant.
package disable
...
Disable an application of a tenant by name
	...
	flags.WithOptions(
		...
		flags.WithPowershellName("Disable-ApplicationByTenant"),
	)
