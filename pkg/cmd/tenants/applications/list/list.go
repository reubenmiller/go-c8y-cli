// v2-based tenants applications list: the tenant flag drives iteration (pipe or
// --tenant); each tenant's referenced applications are listed via
...
Get a list of referenced applications on a given tenant (from management tenant)
	...
	flags.WithOptions(
		...
		flags.WithPowershellName("Get-ApplicationCollectionByTenant"),
