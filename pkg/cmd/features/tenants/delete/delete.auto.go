...
// NewDeleteCmd creates a command to Removes the feature toggle override for a tenant of authenticated user
func NewDeleteCmd(f *cmdutil.Factory) *DeleteCmd {
	...
	cmd := &cobra.Command{
		Use:   "delete",
		Short: "Removes the feature toggle override for a tenant of authenticated user",
		Long:  `Removes the feature toggle override for a tenant of authenticated user`,
		Example: heredoc.Doc(`
$ c8y features tenants delete --key example --tenant t12345
