// v2-based feature update: the key flag drives iteration (pipe or --key) and the
// body builder (active + --data/--template) is evaluated per item, then both
// feed Features.Update for the current tenant.
package update
...
Enable a feature in the current tenant
	...
	flags.WithOptions(
		...
		flags.WithPowershellName("Update-CurrentTenantFeature"),
