// v2-based configuration get: the id flag drives iteration (pipe or --id); each
// configuration reference (id or name, resolved scoped to configuration files)
// is fetched via Configuration.Get.
package get
...
Get a configuration package
	...
	flags.WithOptions(
		...
		flags.WithPowershellName("Get-Configuration"),
...
func (n *GetCmd) RunE(cmd *cobra.Command, args []string) error {
	...
	return r.Run(func(in *c8ystream.Resolver) (c8ystream.Call, error) {
		...
		return func(ctx context.Context) output.Seq {
			return c8ystream.FromResult(client.Configuration.Get(ctx, ref, opt))
		}, nil
	})
}
