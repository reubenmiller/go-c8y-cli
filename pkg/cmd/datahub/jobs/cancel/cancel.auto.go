...
// NewCancelCmd creates a command to Cancel a query job given the ID of the Dremio job executing the query
...
func (n *CancelCmd) RunE(cmd *cobra.Command, args []string) error {
	...
	// path parameters
	path := flags.NewStringTemplate("service/datahub/dremio/api/v3/job/{id}/cancel")
