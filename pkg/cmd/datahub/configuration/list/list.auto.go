...
// NewListCmd creates a command to Get offloading configurations
...
List the datahub offloading configurations
	...
	flags.WithOptions(
		...
		flags.WithCollectionProperty("data.offloadingConfigurations"),
	)
...
func (n *ListCmd) RunE(cmd *cobra.Command, args []string) error {
	...
	err = flags.WithQueryParameters(
		...
		flags.WithStringValue("lastMaxReportedUUID", "lastMaxReportedUUID"),
		flags.WithStringValue("locale", "locale"),
	)
	if err != nil {
	...
	// path parameters
	path := flags.NewStringTemplate("service/datahub/offloadingconfigurations")
