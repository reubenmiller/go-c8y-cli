// v2-based microservice update: the id flag drives iteration (pipe or --id) and
// the body builder (key/availability/contextPath/resourcesUrl + --data/--template)
// is evaluated per item, then both feed Microservices.Update (the id/name
...
Update microservice availability to MARKET
	...
	flags.WithOptions(
		...
		flags.WithPowershellName("Update-Microservice"),
...
func (n *UpdateCmd) RunE(cmd *cobra.Command, args []string) error {
	...
	return r.Run(func(in *c8ystream.Resolver) (c8ystream.Call, error) {
		...
		return func(ctx context.Context) output.Seq {
			return c8ystream.Submit(ctx, func(ctx context.Context) op.Result[jsonmodels.Microservice] {
				return client.Microservices.Update(ctx, ref, body)
			})
		}, nil
	})
}
