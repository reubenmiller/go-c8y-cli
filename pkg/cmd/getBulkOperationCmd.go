...
func (n *getBulkOperationCmd) getBulkOperation(cmd *cobra.Command, args []string) error {
	...
	return n.doGetBulkOperation(req, outputfile, filters)
}

func (n *getBulkOperationCmd) doGetBulkOperation(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
