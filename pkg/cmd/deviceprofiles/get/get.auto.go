...
// NewGetCmd creates a command to Get device profile
func NewGetCmd(f *cmdutil.Factory) *GetCmd {
	...
	cmd := &cobra.Command{
		Use:   "get",
		Short: "Get device profile",
		Long:  `Get an existing device profile (managedObject)`,
		Example: heredoc.Doc(`
$ c8y deviceprofiles get --id 12345
