// v2-based device profile get: the id flag drives iteration (pipe or --id); each
// device-profile reference (id or name, resolved scoped to device profiles) is
// fetched via DeviceProfiles.Get.
package get
...
Get a device profile
	...
	flags.WithOptions(
		...
		flags.WithPowershellName("Get-DeviceProfile"),
...
func (n *GetCmd) RunE(cmd *cobra.Command, args []string) error {
	...
	return r.Run(func(in *c8ystream.Resolver) (c8ystream.Call, error) {
		...
		return func(ctx context.Context) output.Seq {
			return c8ystream.FromResult(client.DeviceProfiles.Get(ctx, ref, opt))
		}, nil
	})
}
