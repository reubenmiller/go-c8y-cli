...
func (n *deleteBulkOperationCmd) deleteBulkOperation(cmd *cobra.Command, args []string) error {
	...
	return n.doDeleteBulkOperation(req, outputfile, filters)
}

func (n *deleteBulkOperationCmd) doDeleteBulkOperation(req c8y.RequestOptions, outputfile string, filters *JSONFilters) error {
