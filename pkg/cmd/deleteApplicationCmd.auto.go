...
// DeleteApplicationCmd command
type DeleteApplicationCmd struct {
	*baseCmd
}

// NewDeleteApplicationCmd creates a command to Delete application
...
func (n *DeleteApplicationCmd) RunE(cmd *cobra.Command, args []string) error {
	var err error
