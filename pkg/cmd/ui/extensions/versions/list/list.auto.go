...
// NewListCmd creates a command to Get extension version collection
func NewListCmd(f *cmdutil.Factory) *ListCmd {
	...
	cmd := &cobra.Command{
		Use:   "list",
		Short: "Get extension version collection",
		Long:  `Get a collection of extension versions by a given filter`,
		Example: heredoc.Doc(`
