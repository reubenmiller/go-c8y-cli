...
// NewGetCmd creates a command to Get a specific version of an extension
func NewGetCmd(f *cmdutil.Factory) *GetCmd {
	...
	cmd := &cobra.Command{
		Use:   "get",
		Short: "Get a specific version of an extension",
		Long:  `Retrieve the selected version of an extension in your tenant. To select the version, use only the version or only the tag query parameter`,
		Example: heredoc.Doc(`
$ c8y ui extensions versions get --extension 1234 --tag tag1
Get extension version by tag

$ c8y ui extensions versions get --extension 1234 --version 1.0
Get extension version by version name
	...
	cmd.Flags().String("version", "", "The version field of the extension version")
