...
// NewGetCmd creates a command to Get UI extension
func NewGetCmd(f *cmdutil.Factory) *GetCmd {
	...
	cmd := &cobra.Command{
		Use:   "get",
		Short: "Get UI extension",
		Long:  `Get a UI Extension`,
		Example: heredoc.Doc(`
$ c8y ui extensions get --id 1234
Get ui extension by id

$ c8y ui extensions get --id myextension
Get ui extension by name
        `),
