...
// NewListCmd creates a command to Get UI extensions collection
func NewListCmd(f *cmdutil.Factory) *ListCmd {
	...
	cmd := &cobra.Command{
		Use:   "list",
		Short: "Get UI extensions collection",
		Long:  `Get a collection of UI extensions by a given filter`,
		Example: heredoc.Doc(`
$ c8y ui extensions list --pageSize 100
Get ui extensions

$ c8y ui extensions list --availability SHARED
Get shared ui extensions

$ c8y ui extensions list --availability PRIVATE
Get private ui extensions
        `),
	...
	cmd.Flags().String("name", "", "The name of the application. (accepts pipeline)")
	...
	cmd.Flags().Bool("hasVersions", true, "When set to true, the returned result contains applications with an applicationVersions field that is not empty. When set to false, the result will contain applications with an empty applicationVersions field.")
