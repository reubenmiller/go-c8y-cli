...
import (
	...
	cmdList "github.com/reubenmiller/go-c8y-cli/v2/pkg/cmd/ui/applications/plugins/list"
...
func NewSubCommand(f *cmdutil.Factory) *SubCmdPlugins {
	...
	cmd := &cobra.Command{
		Use:   "plugins",
		Short: "Cumulocity UI Application plugin management",
	...
	cmd.AddCommand(cmdList.NewCmd(f).GetCommand())
