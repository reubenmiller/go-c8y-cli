...
var (
	DefaultHome = []string{
		...
		"/usr/local/etc/go-c8y-cli",                 // Homebrew prefix for macOS on Intel
		"/opt/homebrew/etc/go-c8y-cli",              // Homebrew prefix for macOS on ARM
		"/home/linuxbrew/.linuxbrew/etc/go-c8y-cli", // Homebrew prefix for linux
