...
test01 () {
    ...
    values=$( c8y $SUBCOMMAND subscribeAll --device "$mo_id" --duration 10s || true )
...
test02 () {
    ...
    values=$( c8y $SUBCOMMAND subscribeAll --device "$mo_id" --count 2 || true )
    item_count=$( echo "$values" | c8y util show --select id -o csv | wc -l )
...
test03 () {
    ...
    values=$( c8y $SUBCOMMAND subscribeAll --count 2 || true )
    item_count=$( echo "$values" | c8y util show --select id -o csv | wc -l )
