function Update-ManagedObjectCollectionBatch {
<#
.SYNOPSIS
Update a collection of new inventory managed objects using client side batching

.DESCRIPTION
Update a collection of new inventory managed objects using client side batching

.EXAMPLE
PS> Update-ManagedObjectCollectionBatch -InputFile "mylist.csv" -Data @{ custom_data = @{ value = 1 } } -WhatIf
