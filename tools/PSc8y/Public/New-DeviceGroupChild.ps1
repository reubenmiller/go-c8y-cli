...
.LINK
https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devicegroups_children_create

.EXAMPLE
PS> New-DeviceGroupChild -Id $software.id -Data "custom.value=test" -Global -ChildType childAdditions
...
#>
    ...
    Begin {
        ...
        $c8yargs = New-ClientArgument -Parameters $PSBoundParameters -Command "devicegroups children create"
    ...
    Process {
        ...
        if ($ClientOptions.ConvertToPS) {
            ...
            | c8y devicegroups children create $c8yargs `
