...
Function Add-ChildAdditionToDeviceGroup {
<#
.SYNOPSIS
...
.EXAMPLE
PS> Add-ChildAdditionToDeviceGroup -Group $Group.id -Child $Device.id

Add a device to a group

.EXAMPLE
PS> Add-ChildAdditionToDeviceGroup -Group $Group -Child $Device
