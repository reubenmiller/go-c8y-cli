...
Function Get-ManagedObjectChild {
<#
.SYNOPSIS
Get child
...
#>
    ...
    Begin {
        ...
        $c8yargs = New-ClientArgument -Parameters $PSBoundParameters -Command "inventory children get"
    ...
    Process {
        ...
        if ($ClientOptions.ConvertToPS) {
            ...
            | c8y inventory children get $c8yargs `
