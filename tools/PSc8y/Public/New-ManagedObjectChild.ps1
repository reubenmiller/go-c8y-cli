...
Function New-ManagedObjectChild {
<#
.SYNOPSIS
Create child
...
.LINK
https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/inventory_children_create

.EXAMPLE
PS> New-ManagedObjectChild -Id $software.id -Data "custom.value=test" -Global -ChildType childAdditions
...
#>
    ...
    Begin {
        ...
        $c8yargs = New-ClientArgument -Parameters $PSBoundParameters -Command "inventory children create"
    ...
    Process {
        ...
        if ($ClientOptions.ConvertToPS) {
            ...
            | c8y inventory children create $c8yargs `
