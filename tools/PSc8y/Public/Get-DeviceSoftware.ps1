...
.LINK
https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devices_software_get

.EXAMPLE
PS> Get-DeviceSoftware -Id 12345
...
#>
    ...
    Begin {
        ...
        $c8yargs = New-ClientArgument -Parameters $PSBoundParameters -Command "devices software get"
    ...
    Process {
        ...
        if ($ClientOptions.ConvertToPS) {
            ...
            | c8y devices software get $c8yargs `
