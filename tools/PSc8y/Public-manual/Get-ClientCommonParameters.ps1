...
#>
    ...
    Process {
        ...
        New-DynamicParam -Name SessionMode -Type "string" -DPDictionary $Dictionary -HelpMessage "Override default session mode for a single command which would normally be disabled"
        if ($ParentCommand) {
