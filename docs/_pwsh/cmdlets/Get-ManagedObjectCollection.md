...
### EXAMPLE 2
```
Get-ManagedObjectCollection -Device $Device1.name, $Device2.name
```
...
### -SkipChildrenNames
Don't include the child devices names in the resonse.
This can improve the api's response because the names don't need to be retrieved
