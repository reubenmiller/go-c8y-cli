...
```
c8y inventoryReferences assignGroupToGroup [flags]
```
...
```
  ...
  -h, --help                    help for assignGroupToGroup
      --newChildGroup strings   New child group to be added to the group as an child asset (required) (accepts pipeline)
