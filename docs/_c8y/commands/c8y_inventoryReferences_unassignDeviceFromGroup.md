...
```
c8y inventoryReferences unassignDeviceFromGroup [flags]
```
...
```
      --childDevice strings     Child device (required) (accepts pipeline)
      --group strings           Asset id (required)
  -h, --help                    help for unassignDeviceFromGroup
