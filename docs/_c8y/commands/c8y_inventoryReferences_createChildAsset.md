...
category: inventoryReferences
title: createChildAsset
---
...
```
c8y inventoryReferences createChildAsset [flags]
```
...
```
      --group strings            Group (required)
  -h, --help                     help for createChildAsset
      --newChildDevice strings   New child device to be added to the group as an asset (accepts pipeline)
      --newChildGroup strings    New child device group to be added to the group as an asset
