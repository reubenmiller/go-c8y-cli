...
```
c8y inventoryReferences assignDeviceToGroup [flags]
```
...
```
  ...
  -h, --help                     help for assignDeviceToGroup
      --newChildDevice strings   New device to be added to the group as an child asset (required) (accepts pipeline)
