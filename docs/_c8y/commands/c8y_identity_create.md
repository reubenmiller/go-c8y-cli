...
```
  ...
  -h, --help                    help for create
      --name string             The identifier used in the external system that Cumulocity interfaces with. (required)
      --processingMode string   Processing mode
      --type string             The type of the external identifier as string, e.g. 'com_cumulocity_model_idtype_SerialNumber'. (required)
```
