...
```
c8y inventoryReferences assignChildDevice [flags]
```
...
```
      --device strings          Device. (required)
  -h, --help                    help for assignChildDevice
      --newChild strings        New child device (required) (accepts pipeline)
