...
```
c8y devices listDeviceGroups [flags]
```
...
```
      ...
      --fragmentType string   Device group fragment type.
  -h, --help                  help for listDeviceGroups
      --name string           Device group name.
      --owner string          Device group owner.
      --query string          Additional query filter
      --type string           Device group type.
