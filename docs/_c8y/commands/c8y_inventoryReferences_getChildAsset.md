...
```
c8y inventoryReferences getChildAsset [flags]
```
...
```
      --asset strings       Asset id (required) (accepts pipeline)
  -h, --help                help for getChildAsset
      --reference strings   Asset reference id (required)
```
