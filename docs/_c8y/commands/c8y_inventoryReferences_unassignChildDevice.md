...
```
c8y inventoryReferences unassignChildDevice [flags]
```
...
```
      --childDevice strings     Child device reference (required) (accepts pipeline)
      --device strings          ManagedObject id (required)
  -h, --help                    help for unassignChildDevice
