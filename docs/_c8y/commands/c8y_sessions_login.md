...
Login and test the Cumulocity session and get either OAuth2 token, or using two factor authentication
...
```
      --clear            Clear any existing cookies
      --env              Return environment variables
  -h, --help             help for login
      --shell string     Shell type (default "bash")
