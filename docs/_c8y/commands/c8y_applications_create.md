...
```
  ...
  -h, --help                       help for create
      --key string                 Shared secret of application (required)
      --name string                Name of application (required)
      --processingMode string      Processing mode
      --resourcesPassword string   authorization password to access resourcesUrl
      ...
      --type string                Type of application. Possible values are EXTERNAL, HOSTED, MICROSERVICE (required)
```
