...
```
c8y inventoryReferences unassignAssetFromGroup [flags]
```
...
```
      --childDevice strings     Child device (accepts pipeline)
      --childGroup strings      Child device group
      --group strings           Asset id (required)
  -h, --help                    help for unassignAssetFromGroup
