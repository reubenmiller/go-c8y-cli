...
```
c8y inventoryReferences getChildDevice [flags]
```
...
```
      --device strings      ManagedObject id (required) (accepts pipeline)
  -h, --help                help for getChildDevice
      --reference strings   Device reference id (required)
```
