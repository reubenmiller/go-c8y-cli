...
---
## c8y currentUser updateCurrentUser
...
```
c8y currentUser updateCurrentUser [flags]
```
...
```
      ...
      --enabled string          User activation status (true/false)
      --firstName string        User first name
  -h, --help                    help for updateCurrentUser
