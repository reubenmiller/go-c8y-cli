...
|  | `c8y currenttenant listapplications` | GET | `/tenant/currentTenant` | M | ⚠️ Tenants.Current +method |
|  | `c8y currenttenant version` | GET | `/tenant/system/options/system/version` | M | ⚠️ Tenants.Current +method |
