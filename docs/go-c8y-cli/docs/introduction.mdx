...
* [c8y](cli) - Native binary. Can be run on any shell you want, but zsh is recommended as tab completion looks really nice there :)
...
* Create shorthands using [c8y alias set](cli/c8y/alias/c8y_alias_set)
* Make custom API queries using [c8y api](cli/c8y/api/c8y_api)
