---
category: tenants
title: c8y features tenants disable
---
...
```
c8y features tenants disable [flags]
```
...
$ c8y features tenants list --key ui.datapoint-graph.v2 | c8y features tenants disable --key ui.datapoint-graph.v2
