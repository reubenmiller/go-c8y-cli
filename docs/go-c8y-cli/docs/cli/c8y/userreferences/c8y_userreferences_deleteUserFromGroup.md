---
category: userreferences
title: c8y userreferences deleteUserFromGroup
---
...
```
c8y userreferences deleteUserFromGroup [flags]
```
...
```
      --group strings           Group ID (required)
  -h, --help                    help for deleteUserFromGroup
      --processingMode string   Cumulocity processing mode
      --tenant string           Tenant
      --user strings            User id/username (required) (accepts pipeline)
```
