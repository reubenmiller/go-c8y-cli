...
title: c8y userreferences addUserToGroup
---
Add user to group
...
```
c8y userreferences addUserToGroup [flags]
```
...
```
  ...
  -h, --help                    help for addUserToGroup
      --processingMode string   Cumulocity processing mode
      --tenant string           Tenant
      --user strings            User id (required) (accepts pipeline)
```
