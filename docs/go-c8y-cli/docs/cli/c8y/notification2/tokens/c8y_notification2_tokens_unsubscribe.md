---
category: tokens
title: c8y notification2 tokens unsubscribe
---
...
```
c8y notification2 tokens unsubscribe [flags]
```
...
```
  -h, --help                    help for unsubscribe
      ...
      --token string            Subscriptions associated with this token will be removed (required) (accepts pipeline)
```
