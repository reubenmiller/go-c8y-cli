...
title: c8y notification2 subscriptions get
---
Get subscription
...
```
c8y notification2 subscriptions get [flags]
```

### Examples

```
$ c8y notification2 subscriptions get --id 12345
Get an existing subscription

$ echo 12345 | c8y notification2 subscriptions get
Get an existing subscription (using pipeline)
...
```
  -h, --help        help for get
      --id string   Unique identifier of the notification subscription. (required) (accepts pipeline)
```
