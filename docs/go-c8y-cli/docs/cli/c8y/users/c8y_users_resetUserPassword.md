---
category: users
title: c8y users resetUserPassword
---
Reset user password
...
```
  -h, --help                    help for resetUserPassword
      --id strings              User id (required) (accepts pipeline)
      --newPassword string      New user password. Min: 6, max: 32 characters. Only Latin1 chars allowed
