...
title: c8y deviceregistration register-basic
---
Register device with username/password credentials

### Synopsis

Register a new device which will authenticate with username/password credentials

```
c8y deviceregistration register-basic [flags]
```
...
```
  ...
  -h, --help                       help for register-basic
      ...
      --password string            Device password. Leave blank for a randomly generated password
