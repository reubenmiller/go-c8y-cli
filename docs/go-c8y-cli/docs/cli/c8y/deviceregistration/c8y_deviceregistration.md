...
title: c8y deviceregistration
---
Cumulocity device credentials

### Synopsis

REST endpoint to interact with Cumulocity device credentials api

### Options

```
  -h, --help   help for deviceregistration
```
