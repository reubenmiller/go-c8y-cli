...
title: c8y activitylog list
---
Get activity log entries

### Synopsis

View activity log entries and filter for specific information

```
c8y activitylog list [flags]
```
...
```
      --dateFrom string   Start date or date and time of the log entry
      --dateTo string     End date or date and time of the log entry
  -h, --help              help for list
      --type string       Type of entry (default "request")
```
