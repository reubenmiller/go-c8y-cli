---
category: userroles
title: c8y userroles getRoleReferenceCollectionFromUser
---
...
```
c8y userroles getRoleReferenceCollectionFromUser [flags]
```
...
```
  -h, --help            help for getRoleReferenceCollectionFromUser
      --tenant string   Tenant
      --user strings    User (required) (accepts pipeline)
```
