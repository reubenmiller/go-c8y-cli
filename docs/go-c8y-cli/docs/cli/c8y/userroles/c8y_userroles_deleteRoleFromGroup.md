---
category: userroles
title: c8y userroles deleteRoleFromGroup
---
...
```
c8y userroles deleteRoleFromGroup [flags]
```
...
```
  ...
  -h, --help                    help for deleteRoleFromGroup
      --processingMode string   Cumulocity processing mode
      --role strings            Role name, e.g. ROLE_TENANT_MANAGEMENT_ADMIN (required) (accepts pipeline)
