---
category: userroles
title: c8y userroles addRoleToUser
---
Add Role to user
...
```
c8y userroles addRoleToUser [flags]
```
...
```
  -h, --help                    help for addRoleToUser
      --processingMode string   Cumulocity processing mode
      --role strings            User role id (accepts pipeline)
      --tenant string           Tenant
      --user strings            User prefix or full username (required)
```
