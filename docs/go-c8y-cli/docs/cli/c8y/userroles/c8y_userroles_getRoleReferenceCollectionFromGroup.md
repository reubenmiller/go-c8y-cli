---
category: userroles
title: c8y userroles getRoleReferenceCollectionFromGroup
---
...
```
c8y userroles getRoleReferenceCollectionFromGroup [flags]
```
...
```
      --group strings   Group id (required) (accepts pipeline)
  -h, --help            help for getRoleReferenceCollectionFromGroup
