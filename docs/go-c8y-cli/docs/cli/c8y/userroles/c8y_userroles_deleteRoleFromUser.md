---
category: userroles
title: c8y userroles deleteRoleFromUser
---
...
```
c8y userroles deleteRoleFromUser [flags]
```
...
```
  -h, --help                    help for deleteRoleFromUser
      --processingMode string   Cumulocity processing mode
      --role strings            Role name (required) (accepts pipeline)
      --tenant string           Tenant
      --user strings            User (required)
```
