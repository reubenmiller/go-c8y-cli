...
title: c8y remoteaccess configurations create-webssh
---
...
```
c8y remoteaccess configurations create-webssh [flags]
```
...
```
      --credentialsType string   Credentials type (default "USER_PASS")
      --device strings           Device (accepts pipeline)
  -h, --help                     help for create-webssh
      ...
      --privateKey string        Private ssh key
      --processingMode string    Cumulocity processing mode
      --protocol string          Protocol (default "SSH")
      --publicKey string         Public ssh key
