...
title: c8y remoteaccess configurations create-telnet
---
...
```
c8y remoteaccess configurations create-telnet [flags]
```
...
```
  ...
  -h, --help                    help for create-telnet
      --hostname string         Hostname (default "127.0.0.1")
      --name string             Connection name (default "telnet")
      --port int                Port (default 23)
      --processingMode string   Cumulocity processing mode
      --protocol string         Protocol (default "TELNET")
```
