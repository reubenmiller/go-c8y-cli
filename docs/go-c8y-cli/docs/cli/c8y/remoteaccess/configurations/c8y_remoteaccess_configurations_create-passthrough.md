...
title: c8y remoteaccess configurations create-passthrough
---
...
```
c8y remoteaccess configurations create-passthrough [flags]
```
...
```
  ...
  -h, --help                    help for create-passthrough
      --hostname string         Hostname (default "127.0.0.1")
      --name string             Connection name (default "passthrough")
      --port int                Port (default 22)
      --processingMode string   Cumulocity processing mode
      --protocol string         Protocol (default "PASSTHROUGH")
```
