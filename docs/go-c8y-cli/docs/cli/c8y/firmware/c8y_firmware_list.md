...
```
      --description string     Firmware description filter
      --deviceType string      Firmware device type filter
  -h, --help                   help for list
      --name string            Firmware name filter
