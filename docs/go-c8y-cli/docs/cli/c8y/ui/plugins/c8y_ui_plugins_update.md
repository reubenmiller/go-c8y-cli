...
```
      --availability string        Access level for other tenants
      --contextPath string         contextPath of the plugin
  ...
  -h, --help                       help for update
      --id string                  Plugin (required) (accepts pipeline)
      --key string                 Shared secret of the plugin
