---
category: versions
title: c8y ui plugins versions delete
---
...
```
c8y ui plugins versions delete [flags]
```
...
```
  -h, --help                    help for delete
      ...
      --tag string              The tag of the plugin version
      --version string          Version, e.g. 1.0.0 (accepts pipeline)
```
