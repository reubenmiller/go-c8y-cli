---
category: plugins
title: c8y ui applications plugins replace
---
Replace UI plugins in an application
...
```
c8y ui applications plugins replace [flags]
```
...
```
  ...
  -h, --help                       help for replace
      --plugin strings             UI plugin to be installed
