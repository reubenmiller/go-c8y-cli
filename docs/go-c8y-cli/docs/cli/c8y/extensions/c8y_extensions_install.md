---
category: extensions
title: c8y extensions install
---
Install a c8y extensions from a repository
...
```
c8y extensions install <repository> [flags]
```
...
```
  -h, --help          help for install
      --name string   use custom name for the extension
