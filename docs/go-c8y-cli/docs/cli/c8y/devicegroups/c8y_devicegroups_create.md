...
```
  ...
  -h, --help                       help for create
      ...
      --type string                Device group type (c8y_DeviceGroup (root folder) or c8y_DeviceSubGroup (sub folder)). Defaults to c8y_DeviceGroup
```
