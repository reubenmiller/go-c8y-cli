---
category: children
title: c8y devicegroups children assign
---
Assign child
...
```
c8y devicegroups children assign [flags]
```
...
```
      --child string            Managed object that will be assigned as a child (required) (accepts pipeline)
      --childType string        Child relationship type (required)
  -h, --help                    help for assign
      --id strings              Managed object id where the child will be assigned to (required)
