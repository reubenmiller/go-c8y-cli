...
title: c8y devicegroups unassignGroup
---
...
```
c8y devicegroups unassignGroup [flags]
```
...
```
      --child strings           Child device group (required) (accepts pipeline)
  -h, --help                    help for unassignGroup
      --id strings              Device group (required)
