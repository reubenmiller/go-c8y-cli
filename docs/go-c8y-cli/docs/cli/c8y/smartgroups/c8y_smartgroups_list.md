...
```
      --deviceQuery string     Filter by device query
      --fragmentType string    Filter by fragment type
  -h, --help                   help for list
      --name string            Filter by name
      --onlyInvisible          Only include invisible smart groups
      --onlyVisible            Only include visible smart groups
