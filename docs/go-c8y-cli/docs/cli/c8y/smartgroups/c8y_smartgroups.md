...
title: c8y smartgroups
---
Cumulocity smart groups

### Synopsis

REST endpoint to interact with Cumulocity smart groups. A smart group is an inventory managed object and can also be managed via the Inventory api.

### Options

```
  -h, --help   help for smartgroups
```
