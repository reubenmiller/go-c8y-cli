...
```
  ...
  -h, --help                       help for update
      ...
      --strategy string            Two-factor authentication strategy
      --template string            Body template
      --templateVars stringArray   Body template variables
      --tenant string              Tenant id. Defaults to current tenant
```
