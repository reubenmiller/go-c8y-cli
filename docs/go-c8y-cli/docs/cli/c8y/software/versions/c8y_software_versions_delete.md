---
category: versions
title: c8y software versions delete
---
...
```
c8y software versions delete [flags]
```
...
```
      --forceCascade            Remove version and any related binaries (default true)
  -h, --help                    help for delete
      --id strings              Software Package version id or name (required) (accepts pipeline)
      --processingMode string   Cumulocity processing mode
      --software strings        Software package id (used to help completion be more accurate)
```
