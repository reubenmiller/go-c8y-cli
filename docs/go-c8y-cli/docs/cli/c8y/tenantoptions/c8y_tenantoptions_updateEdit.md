...
title: c8y tenantoptions updateEdit
---
...
```
c8y tenantoptions updateEdit [flags]
```
...
```
      ...
      --editable string         Whether the tenant option should be editable or not (required)
  -h, --help                    help for updateEdit
