---
category: loglevels
title: c8y microservices loglevels set
---
...
```
c8y microservices loglevels set [flags]
```
...
```
  -h, --help                    help for set
      --logLevel string         Log level: TRACE | DEBUG | INFO | WARN | ERROR | OFF (required)
      --loggerName string       Name of the logger: Qualified name of package or class (required)
      --name string             Microservice name (required)
