...
title: c8y currentapplication
---
Cumulocity currentApplication

### Synopsis

REST endpoint to interact with Cumulocity currentApplication

### Options

```
  -h, --help   help for currentapplication
```
