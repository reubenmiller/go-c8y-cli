...
id: Add-DeviceToGroup
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devicegroups_assignDevice
schema: 2.0.0
slug: /docs/cli/psc8y/Devices/add-devicetogroup
title: Add-DeviceToGroup
---
...
The device will be a childAsset of the group

## EXAMPLES

### EXAMPLE 1
```
Add-DeviceToGroup -Group $Group.id -NewChildDevice $Device.id
```
...
### EXAMPLE 3
```
Get-Device $Device1.name, $Device2.name | Add-DeviceToGroup -Group $Group.id
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devicegroups_assignDevice](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devicegroups_assignDevice)
