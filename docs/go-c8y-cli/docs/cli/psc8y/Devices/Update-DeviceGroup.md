...
id: Update-DeviceGroup
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devicegroups_update
schema: 2.0.0
slug: /docs/cli/psc8y/Devices/update-devicegroup
title: Update-DeviceGroup
---
...
### EXAMPLE 1
```
Update-DeviceGroup -Id $group.id -Name "MyNewName"
```
...
### EXAMPLE 2
```
Update-DeviceGroup -Id $group.name -Name "MyNewName"
```
...
### EXAMPLE 3
```
Update-DeviceGroup -Id $group.name -Data @{ "myValue" = @{ value1 = $true } }
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devicegroups_update](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devicegroups_update)
