...
id: Get-DeviceChildCollection
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devices_children_list
schema: 2.0.0
slug: /docs/cli/psc8y/Devices/get-devicechildcollection
title: Get-DeviceChildCollection
---
...
### EXAMPLE 1
```
Get-DeviceChildCollection -Id 12345 -ChildType addition
```
...
### EXAMPLE 2
```
Get-ManagedObject -Id 12345 | Get-DeviceChildCollection -ChildType addition
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devices_children_list](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devices_children_list)
