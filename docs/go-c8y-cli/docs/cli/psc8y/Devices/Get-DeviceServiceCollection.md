...
id: Get-DeviceServiceCollection
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devices_services_list
schema: 2.0.0
slug: /docs/cli/psc8y/Devices/get-deviceservicecollection
title: Get-DeviceServiceCollection
---
...
### EXAMPLE 1
```
Get-DeviceServiceCollection -Device 12345
```
...
### EXAMPLE 2
```
Get-Device -Id 12345 | Get-DeviceServiceCollection
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devices_services_list](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devices_services_list)
