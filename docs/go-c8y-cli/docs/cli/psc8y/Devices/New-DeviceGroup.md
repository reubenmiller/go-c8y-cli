...
id: New-DeviceGroup
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devicegroups_create
schema: 2.0.0
slug: /docs/cli/psc8y/Devices/new-devicegroup
title: New-DeviceGroup
---
...
### EXAMPLE 1
```
New-DeviceGroup -Name $GroupName
```
...
### EXAMPLE 2
```
New-DeviceGroup -Name $GroupName -Data @{ "myValue" = @{ value1 = $true } }
```
...
### -Type
Device group type (c8y_DeviceGroup (root folder) or c8y_DeviceSubGroup (sub folder)).
Defaults to c8y_DeviceGroup
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devicegroups_create](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devicegroups_create)
