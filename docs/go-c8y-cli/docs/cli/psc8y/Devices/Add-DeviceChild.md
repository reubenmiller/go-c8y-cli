...
id: Add-DeviceChild
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devices_children_assign
schema: 2.0.0
slug: /docs/cli/psc8y/Devices/add-devicechild
title: Add-DeviceChild
---
...
### EXAMPLE 1
```
Add-DeviceChild -Id $software.id -Child $version.id -ChildType addition
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devices_children_assign](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devices_children_assign)
