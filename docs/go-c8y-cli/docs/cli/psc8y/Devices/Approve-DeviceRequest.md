...
id: Approve-DeviceRequest
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/deviceregistration_approve
schema: 2.0.0
slug: /docs/cli/psc8y/Devices/approve-devicerequest
title: Approve-DeviceRequest
---
...
Note: a device can only be approved if the platform has received a request for device credentials.

## EXAMPLES

### EXAMPLE 1
```
Approve-DeviceRequest -Id $DeviceRequest.id
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/deviceregistration_approve](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/deviceregistration_approve)
