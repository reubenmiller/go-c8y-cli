...
id: New-DeviceService
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devices_services_create
schema: 2.0.0
slug: /docs/cli/psc8y/Devices/new-deviceservice
title: New-DeviceService
---
...
### EXAMPLE 1
```
New-DeviceService -Id $software.id -Data "custom.value=test" -Global -ChildType addition
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devices_services_create](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devices_services_create)
