...
id: Remove-DeviceGroupChild
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devicegroups_children_unassign
schema: 2.0.0
slug: /docs/cli/psc8y/Devices/remove-devicegroupchild
title: Remove-DeviceGroupChild
---
...
### EXAMPLE 1
```
Remove-DeviceGroupChild -Id $software.id -Child $version.id -ChildType addition
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devicegroups_children_unassign](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devicegroups_children_unassign)
