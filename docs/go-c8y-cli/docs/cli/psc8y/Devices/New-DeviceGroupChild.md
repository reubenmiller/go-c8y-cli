...
id: New-DeviceGroupChild
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devicegroups_children_create
schema: 2.0.0
slug: /docs/cli/psc8y/Devices/new-devicegroupchild
title: New-DeviceGroupChild
---
...
### EXAMPLE 1
```
New-DeviceGroupChild -Id $software.id -Data "custom.value=test" -Global -ChildType addition
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devicegroups_children_create](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devicegroups_children_create)
