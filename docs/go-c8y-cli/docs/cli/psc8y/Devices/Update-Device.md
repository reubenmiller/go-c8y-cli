...
id: Update-Device
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devices_update
schema: 2.0.0
slug: /docs/cli/psc8y/Devices/update-device
title: Update-Device
---
...
### EXAMPLE 1
```
Update-Device -Id $device.id -NewName "MyNewName"
```
...
### EXAMPLE 2
```
Update-Device -Id $device.name -NewName "MyNewName"
```
...
### EXAMPLE 3
```
Update-Device -Id $device.name -Data @{ "myValue" = @{ value1 = $true } }
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devices_update](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devices_update)
