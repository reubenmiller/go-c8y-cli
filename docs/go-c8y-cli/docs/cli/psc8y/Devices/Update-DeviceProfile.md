...
id: Update-DeviceProfile
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/deviceprofiles_update
schema: 2.0.0
slug: /docs/cli/psc8y/Devices/update-deviceprofile
title: Update-DeviceProfile
---
...
### EXAMPLE 1
```
Update-DeviceProfile -Id $mo.id -Data @{ com_my_props = @{ value = 1 } }
```
...
### EXAMPLE 2
```
Get-ManagedObject -Id $mo.id | Update-DeviceProfile -Data @{ com_my_props = @{ value = 1 } }
```
...
### -DeviceType
Device type filter.
Only allow device profile to be applied to devices of this type
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/deviceprofiles_update](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/deviceprofiles_update)
