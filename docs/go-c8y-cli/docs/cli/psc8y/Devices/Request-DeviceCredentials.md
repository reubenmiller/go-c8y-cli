...
id: Request-DeviceCredentials
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/deviceregistration_getCredentials
schema: 2.0.0
slug: /docs/cli/psc8y/Devices/request-devicecredentials
title: Request-DeviceCredentials
---
...
Do not use your tenant credentials with this API.

## EXAMPLES

### EXAMPLE 1
```
Request-DeviceCredentials -Id "device-AD76-matrixer"
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/deviceregistration_getCredentials](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/deviceregistration_getCredentials)
