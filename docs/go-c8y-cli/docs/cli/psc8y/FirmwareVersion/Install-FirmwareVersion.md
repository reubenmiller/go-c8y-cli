...
id: Install-FirmwareVersion
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/firmware_versions_install
schema: 2.0.0
slug: /docs/cli/psc8y/FirmwareVersion/install-firmwareversion
title: Install-FirmwareVersion
---
...
### EXAMPLE 1
```
Install-FirmwareVersion -Device $mo.id -Firmware linux-iot -Version 1.0.0
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/firmware_versions_install](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/firmware_versions_install)
