...
id: Remove-FirmwareVersion
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/firmware_versions_delete
schema: 2.0.0
slug: /docs/cli/psc8y/FirmwareVersion/remove-firmwareversion
title: Remove-FirmwareVersion
---
...
### EXAMPLE 1
```
Remove-FirmwareVersion -Id $mo.id
```
...
### EXAMPLE 2
```
Get-ManagedObject -Id $mo.id | Remove-FirmwareVersion
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/firmware_versions_delete](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/firmware_versions_delete)
