...
id: New-Notification2Subscription
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/notification2_subscriptions_create
schema: 2.0.0
slug: /docs/cli/psc8y/Misc/new-notification2subscription
title: New-Notification2Subscription
---
...
### EXAMPLE 1
```
New-Notification2Subscription -Name deviceSub -Device 12345 -Context mo -ApiFilter operations
```
...
Each custom fragment is identified by a unique name.
If nothing is specified here, the data is forwarded as-is.
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/notification2_subscriptions_create](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/notification2_subscriptions_create)
