...
id: Update-CertificateAuthority
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devicemanagement_certificate-authority_update
schema: 2.0.0
slug: /docs/cli/psc8y/Misc/update-certificateauthority
...
### EXAMPLE 1
```
Update-CertificateAuthority -Status DISABLED
```
...
### EXAMPLE 2
```
Update-CertificateAuthority -AutoRegistrationEnabled:$false
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devicemanagement_certificate-authority_update](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devicemanagement_certificate-authority_update)
