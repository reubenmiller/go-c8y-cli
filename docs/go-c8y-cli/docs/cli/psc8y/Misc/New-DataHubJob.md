...
id: New-DataHubJob
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/datahub_jobs_create
schema: 2.0.0
slug: /docs/cli/psc8y/Misc/new-datahubjob
title: New-DataHubJob
---
...
## DESCRIPTION
Submit a SQL query and retrieve the ID of the Dremio job executing this query.
The request is asynchronous, i.e., the response does not wait for the query execution to complete.

## EXAMPLES

### EXAMPLE 1
```
New-DataHubJob -Sql "SELECT * FROM myTenantIdDataLake.Dremio.myTenantId.alarms"
```
...
### EXAMPLE 2
```
New-DataHubJob -Sql "SELECT * FROM alarms" -Context "myTenantIdDataLake", "Dremio", "myTenantId"
```
...
The table to query is either referred to with the full path or with the table name if the context defines the path
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/datahub_jobs_create](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/datahub_jobs_create)
