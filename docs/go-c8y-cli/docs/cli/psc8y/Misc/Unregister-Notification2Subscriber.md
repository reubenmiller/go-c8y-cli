...
id: Unregister-Notification2Subscriber
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/notification2_tokens_unsubscribe
schema: 2.0.0
slug: /docs/cli/psc8y/Misc/unregister-notification2subscriber
title: Unregister-Notification2Subscriber
---
...
They will be deleted if a tenant is deleted.
It can take up considerable space in permanent storage for high-frequency notification sources.
...
### EXAMPLE 1
```
Unregister-Notification2Subscriber -Token "eyJhbGciOiJSUzI1NiJ9"
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/notification2_tokens_unsubscribe](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/notification2_tokens_unsubscribe)
