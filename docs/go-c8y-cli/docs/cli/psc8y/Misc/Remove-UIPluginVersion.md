...
id: Remove-UIPluginVersion
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/ui_plugins_versions_delete
schema: 2.0.0
slug: /docs/cli/psc8y/Misc/remove-uipluginversion
title: Remove-UIPluginVersion
---
...
### EXAMPLE 1
```
Remove-UIPluginVersion -Plugin 1234 -Tag tag1
```
...
### EXAMPLE 2
```
Remove-UIPluginVersion -Plugin 1234 -Version 1.0
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/ui_plugins_versions_delete](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/ui_plugins_versions_delete)
