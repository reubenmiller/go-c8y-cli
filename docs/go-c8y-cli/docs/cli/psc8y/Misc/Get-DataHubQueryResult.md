...
id: Get-DataHubQueryResult
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/datahub_query
schema: 2.0.0
slug: /docs/cli/psc8y/Misc/get-datahubqueryresult
title: Get-DataHubQueryResult
---
...
### EXAMPLE 1
```
Get-DataHubQueryResult -Sql "SELECT * FROM myTenantIdDataLake.Dremio.myTenantId.alarms"
```
...
### -Format
The response format, which is either DREMIO or PANDAS.
The DREMIO format is the same response format as provided by the sql endpoint of the Standard API.
The PANDAS format fits to the data format the Pandas library for Python expects.
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/datahub_query](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/datahub_query)
