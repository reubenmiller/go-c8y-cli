...
id: Update-UserGroup
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/usergroups_update
schema: 2.0.0
slug: /docs/cli/psc8y/Users/update-usergroup
...
### EXAMPLE 1
```
Update-UserGroup -Id $Group -Name $GroupName
```
...
### EXAMPLE 2
```
Get-UserGroupByName -Name $Group.name | Update-UserGroup -Name $NewGroupName
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/usergroups_update](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/usergroups_update)
