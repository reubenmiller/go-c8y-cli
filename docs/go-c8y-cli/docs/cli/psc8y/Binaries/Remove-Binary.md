...
id: Remove-Binary
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/binaries_delete
schema: 2.0.0
slug: /docs/cli/psc8y/Binaries/remove-binary
title: Remove-Binary
---
...
## DESCRIPTION
Delete a binary from the tenant.
This delete operation can not be undone.

## EXAMPLES

### EXAMPLE 1
```
Remove-Binary -Id $Binary.id
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/binaries_delete](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/binaries_delete)
