...
id: Update-Binary
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/binaries_update
schema: 2.0.0
slug: /docs/cli/psc8y/Binaries/update-binary
title: Update-Binary
---
...
### EXAMPLE 1
```
Update-Binary -Id $Binary1.id -File $File2
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/binaries_update](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/binaries_update)
