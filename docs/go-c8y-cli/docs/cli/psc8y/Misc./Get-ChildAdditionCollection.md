...
id: Get-ChildAdditionCollection
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/inventory_additions_list
schema: 2.0.0
slug: /docs/cli/psc8y/Misc./get-childadditioncollection
title: Get-ChildAdditionCollection
---
...
### EXAMPLE 1
```
Get-ChildAdditionCollection -Id $software.id
```
...
### EXAMPLE 2
```
Get-ManagedObject -Id $software.id | Get-ChildAdditionCollection
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/inventory_additions_list](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/inventory_additions_list)
