...
id: Install-SoftwareVersion
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/software_versions_install
schema: 2.0.0
slug: /docs/cli/psc8y/SoftwareVersion/install-softwareversion
title: Install-SoftwareVersion
---
...
### EXAMPLE 1
```
Install-SoftwareVersion -Device $mo.id -Software go-c8y-cli -Version 1.0.0
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/software_versions_install](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/software_versions_install)
