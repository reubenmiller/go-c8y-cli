...
id: Get-ApplicationVersion
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/applications_versions_get
schema: 2.0.0
slug: /docs/cli/psc8y/Applications/get-applicationversion
title: Get-ApplicationVersion
---
...
## DESCRIPTION
Retrieve the selected version of an application in your tenant.
...
### EXAMPLE 1
```
Get-ApplicationVersion -Application 1234 -Tag tag1
```
...
### EXAMPLE 2
```
Get-ApplicationVersion -Application 1234 -Version 1.0
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/applications_versions_get](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/applications_versions_get)
