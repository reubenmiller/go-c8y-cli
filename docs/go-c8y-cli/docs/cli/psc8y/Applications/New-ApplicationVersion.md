...
id: New-ApplicationVersion
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/applications_versions_create
schema: 2.0.0
slug: /docs/cli/psc8y/Applications/new-applicationversion
title: New-ApplicationVersion
---
...
## DESCRIPTION
Uploaded version and tags can only contain upper and lower case letters, integers and ., +, -.
...
### EXAMPLE 1
```
New-ApplicationVersion -Application 1234 -File ./myapp.zip -Version "2.0.0"
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/applications_versions_create](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/applications_versions_create)
