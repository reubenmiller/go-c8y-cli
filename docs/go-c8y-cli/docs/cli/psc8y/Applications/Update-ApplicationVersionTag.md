...
id: Update-ApplicationVersionTag
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/applications_versions_update
schema: 2.0.0
slug: /docs/cli/psc8y/Applications/update-applicationversiontag
title: Update-ApplicationVersionTag
---
...
### EXAMPLE 1
```
Update-ApplicationVersionTag -Application 1234 -Tag tag1
```
...
### EXAMPLE 2
```
Update-ApplicationVersionTag -Application 1234 -Version 1.0
```
...
Version tags must be unique across all versions and version fields of application versions
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/applications_versions_update](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/applications_versions_update)
