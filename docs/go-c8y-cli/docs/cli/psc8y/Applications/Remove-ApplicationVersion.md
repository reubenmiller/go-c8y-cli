...
id: Remove-ApplicationVersion
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/applications_versions_delete
schema: 2.0.0
slug: /docs/cli/psc8y/Applications/remove-applicationversion
title: Remove-ApplicationVersion
---
...
### EXAMPLE 1
```
Remove-ApplicationVersion -Application 1234 -Tag tag1
```
...
### EXAMPLE 2
```
Remove-ApplicationVersion -Application 1234 -Version 1.0
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/applications_versions_delete](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/applications_versions_delete)
