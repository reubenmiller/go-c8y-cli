...
id: Remove-ExternalId
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/identity_delete
schema: 2.0.0
slug: /docs/cli/psc8y/ExternalIdentity/remove-externalid
title: Remove-ExternalId
---
...
## DESCRIPTION
Delete an existing external id.
This does not delete the device managed object

## EXAMPLES

### EXAMPLE 1
```
Remove-ExternalId -Type "my_SerialNumber" -Name "myserialnumber2"
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/identity_delete](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/identity_delete)
