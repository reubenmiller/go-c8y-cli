...
id: Add-RoleToGroup
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/userroles_addRoleToGroup
schema: 2.0.0
slug: /docs/cli/psc8y/Role/add-roletogroup
title: Add-RoleToGroup
---
...
### EXAMPLE 1
```
Add-RoleToGroup -Group "${NamePattern}*" -Role "*ALARM_*"
```
...
### EXAMPLE 2
```
Get-RoleCollection -PageSize 100 | Where-Object Name -like "*ALARM*" | Add-RoleToGroup -Group "${NamePattern}*"
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/userroles_addRoleToGroup](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/userroles_addRoleToGroup)
