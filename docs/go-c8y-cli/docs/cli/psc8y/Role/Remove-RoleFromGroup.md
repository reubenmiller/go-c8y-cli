...
id: Remove-RoleFromGroup
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/userroles_deleteRoleFromGroup
schema: 2.0.0
slug: /docs/cli/psc8y/Role/remove-rolefromgroup
title: Remove-RoleFromGroup
---
...
### EXAMPLE 1
```
Remove-RoleFromGroup -Group $UserGroup.id -Role "ROLE_MEASUREMENT_READ"
```
...
### -Role
Role name, e.g.
ROLE_TENANT_MANAGEMENT_ADMIN (required)
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/userroles_deleteRoleFromGroup](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/userroles_deleteRoleFromGroup)
