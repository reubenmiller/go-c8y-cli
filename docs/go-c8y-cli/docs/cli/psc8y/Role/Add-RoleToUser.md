...
id: Add-RoleToUser
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/userroles_addRoleToUser
schema: 2.0.0
slug: /docs/cli/psc8y/Role/add-roletouser
title: Add-RoleToUser
---
...
### EXAMPLE 2
```
Add-RoleToUser -User "customUser_*" -Role "*ALARM_*"
```
...
### EXAMPLE 3
```
Get-RoleCollection -PageSize 100 | Where-Object Name -like "*ALARM*" | Add-RoleToUser -User "customUser_*"
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/userroles_addRoleToUser](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/userroles_addRoleToUser)
