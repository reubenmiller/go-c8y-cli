...
id: Get-InventoryRole
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/users_getInventoryRole
schema: 2.0.0
slug: /docs/cli/psc8y/Role/get-inventoryrole
title: Get-InventoryRole
---
...
### EXAMPLE 1
```
Get-InventoryRoleCollection -PageSize 1 | Get-InventoryRole
```
...
### -Id
Role id.
Note: lookup by name is not yet supported (required)
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/users_getInventoryRole](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/users_getInventoryRole)
