...
id: Get-ManagedObjectChildCollection
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/inventory_children_list
schema: 2.0.0
slug: /docs/cli/psc8y/ManagedObjects/get-managedobjectchildcollection
title: Get-ManagedObjectChildCollection
---
...
### EXAMPLE 1
```
Get-ManagedObjectChildCollection -Id 12345 -ChildType addition
```
...
### EXAMPLE 2
```
Get-ManagedObject -Id 12345 | Get-ManagedObjectChildCollection -ChildType addition
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/inventory_children_list](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/inventory_children_list)
