...
id: Remove-ManagedObject
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/inventory_delete
schema: 2.0.0
slug: /docs/cli/psc8y/ManagedObjects/remove-managedobject
title: Remove-ManagedObject
---
...
### EXAMPLE 2
```
Get-ManagedObject -Id $mo.id | Remove-ManagedObject
```
...
### EXAMPLE 3
```
Get-ManagedObject -Id $Device.id | Remove-ManagedObject -Cascade
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/inventory_delete](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/inventory_delete)
