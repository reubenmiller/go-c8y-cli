...
id: Get-ManagedObject
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/inventory_get
schema: 2.0.0
slug: /docs/cli/psc8y/ManagedObjects/get-managedobject
title: Get-ManagedObject
---
...
### EXAMPLE 2
```
Get-ManagedObject -Id $mo.id | Get-ManagedObject
```
...
### EXAMPLE 3
```
Get-ManagedObject -Id $mo.id -WithParents
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/inventory_get](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/inventory_get)
