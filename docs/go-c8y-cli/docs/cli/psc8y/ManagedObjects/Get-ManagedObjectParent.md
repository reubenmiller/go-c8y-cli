...
id: Get-ManagedObjectParent
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/inventory_parents_get
schema: 2.0.0
slug: /docs/cli/psc8y/ManagedObjects/get-managedobjectparent
title: Get-ManagedObjectParent
---
...
### EXAMPLE 1
```
Get-ManagedObjectParent -Id 1234 -Type addition
```
...
### -Type
Type of relationship, e.g.
addition, asset, device
...
### -Level
Number of parent jumps to do.
0 = current item, 1 = parent, 2 = grandparent etc.
Defaults to 1.
Use -1 for last parent
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/inventory_parents_get](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/inventory_parents_get)
