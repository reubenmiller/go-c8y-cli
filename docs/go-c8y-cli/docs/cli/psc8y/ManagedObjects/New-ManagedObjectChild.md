...
id: New-ManagedObjectChild
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/inventory_children_create
schema: 2.0.0
slug: /docs/cli/psc8y/ManagedObjects/new-managedobjectchild
title: New-ManagedObjectChild
---
...
### EXAMPLE 1
```
New-ManagedObjectChild -Id $software.id -Data "custom.value=test" -Global -ChildType addition
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/inventory_children_create](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/inventory_children_create)
