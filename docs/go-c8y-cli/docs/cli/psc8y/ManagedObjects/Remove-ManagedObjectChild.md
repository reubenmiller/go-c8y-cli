...
id: Remove-ManagedObjectChild
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/inventory_children_unassign
schema: 2.0.0
slug: /docs/cli/psc8y/ManagedObjects/remove-managedobjectchild
title: Remove-ManagedObjectChild
---
...
### EXAMPLE 1
```
Remove-ManagedObjectChild -Id $software.id -Child $version.id -ChildType addition
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/inventory_children_unassign](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/inventory_children_unassign)
