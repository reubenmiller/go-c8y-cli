...
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/configuration_send
schema: 2.0.0
slug: /docs/cli/psc8y/Configuration/send-configuration
...
### EXAMPLE 1
```
Send-Configuration -Device mydevice -Configuration 12345
```
...
### EXAMPLE 2
```
Get-DeviceCollection | Send-Configuration -Configuration 12345
```
...
### -ConfigurationType
Configuration type.
Leave blank to automatically set it if a matching configuration is found in the c8y configuration repository
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/configuration_send](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/configuration_send)
