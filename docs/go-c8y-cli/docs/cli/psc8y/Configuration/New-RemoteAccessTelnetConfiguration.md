...
id: New-RemoteAccessTelnetConfiguration
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/remoteaccess_configurations_create-telnet
schema: 2.0.0
slug: /docs/cli/psc8y/Configuration/new-remoteaccesstelnetconfiguration
title: New-RemoteAccessTelnetConfiguration
---
...
### EXAMPLE 1
```
New-RemoteAccessTelnetConfiguration -Device device01
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/remoteaccess_configurations_create-telnet](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/remoteaccess_configurations_create-telnet)
