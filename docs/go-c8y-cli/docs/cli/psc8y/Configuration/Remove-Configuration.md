...
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/configuration_delete
schema: 2.0.0
slug: /docs/cli/psc8y/Configuration/remove-configuration
...
### EXAMPLE 2
```
Get-ManagedObject -Id $mo.id | Remove-Configuration
```
...
### EXAMPLE 3
```
Get-ManagedObject -Id $Device.id | Remove-Configuration -forceCascade:$false
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/configuration_delete](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/configuration_delete)
