...
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/configuration_create
schema: 2.0.0
slug: /docs/cli/psc8y/Configuration/new-configuration
...
### EXAMPLE 1
```
New-Configuration -Name "agent config" -Description "Default agent configuration" -ConfigurationType "agentConfig" -Url "https://test.com/content/raw/app.json" -Data @{$type=@{}}
```
...
### -DeviceType
Device type filter.
Only allow configuration to be applied to devices of this type
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/configuration_create](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/configuration_create)
