...
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/configuration_update
schema: 2.0.0
slug: /docs/cli/psc8y/Configuration/update-configuration
...
### EXAMPLE 1
```
Update-Configuration -Id $mo.id -Data @{ com_my_props = @{ value = 1 } }
```
...
### EXAMPLE 2
```
Get-ManagedObject -Id $mo.id | Update-Configuration -Data @{ com_my_props = @{ value = 1 } }
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/configuration_update](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/configuration_update)
