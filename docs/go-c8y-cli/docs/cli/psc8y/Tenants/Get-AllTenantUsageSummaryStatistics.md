...
id: Get-AllTenantUsageSummaryStatistics
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/tenantstatistics_listSummaryAllTenants
schema: 2.0.0
slug: /docs/cli/psc8y/Tenants/get-alltenantusagesummarystatistics
title: Get-AllTenantUsageSummaryStatistics
---
...
### EXAMPLE 2
```
Get-AllTenantUsageSummaryStatistics -DateFrom "-30d"
```
...
### EXAMPLE 3
```
Get-AllTenantUsageSummaryStatistics -DateFrom "-10d" -DateTo "-9d"
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/tenantstatistics_listSummaryAllTenants](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/tenantstatistics_listSummaryAllTenants)
