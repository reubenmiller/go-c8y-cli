...
id: Get-TenantUsageSummaryStatistics
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/tenantstatistics_listSummaryForTenant
schema: 2.0.0
slug: /docs/cli/psc8y/Tenants/get-tenantusagesummarystatistics
title: Get-TenantUsageSummaryStatistics
---
...
### EXAMPLE 2
```
Get-TenantUsageSummaryStatistics -DateFrom "-30d"
```
...
### EXAMPLE 3
```
Get-TenantUsageSummaryStatistics -DateFrom "-10d" -DateTo "-9d"
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/tenantstatistics_listSummaryForTenant](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/tenantstatistics_listSummaryForTenant)
