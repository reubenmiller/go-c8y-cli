...
id: Update-TenantOptionEditable
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/tenantoptions_updateEdit
schema: 2.0.0
slug: /docs/cli/psc8y/TenantOption/update-tenantoptioneditable
title: Update-TenantOptionEditable
---
...
### EXAMPLE 1
```
Update-TenantOptionEditable -Category "c8y_cli_tests" -Key "$option8" -Editable "true"
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/tenantoptions_updateEdit](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/tenantoptions_updateEdit)
