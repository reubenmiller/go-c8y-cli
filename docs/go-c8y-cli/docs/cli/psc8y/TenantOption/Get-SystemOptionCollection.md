...
id: Get-SystemOptionCollection
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/systemoptions_list
schema: 2.0.0
slug: /docs/cli/psc8y/TenantOption/get-systemoptioncollection
title: Get-SystemOptionCollection
---
...
## DESCRIPTION
Get a collection of system options.
This endpoint provides a set of read-only properties pre-defined in platform configuration.
The response format is exactly the same as for OptionCollection.
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/systemoptions_list](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/systemoptions_list)
