---
category: FirmwarePatch
external help file: PSc8y-help.xml
id: Remove-FirmwarePatch
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/firmware_patches_delete
schema: 2.0.0
slug: /docs/cli/psc8y/FirmwarePatch/remove-firmwarepatch
title: Remove-FirmwarePatch
---
...
### EXAMPLE 2
```
Get-ManagedObject -Id $mo.id | Remove-FirmwarePatch
```
...
### EXAMPLE 3
```
Get-ManagedObject -Id $Device.id | Remove-FirmwarePatch -ForceCascade
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/firmware_patches_delete](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/firmware_patches_delete)
