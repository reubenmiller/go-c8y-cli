...
id: Remove-Software
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/software_delete
schema: 2.0.0
slug: /docs/cli/psc8y/Software/remove-software
...
### EXAMPLE 1
```
Get-ManagedObject -Id $mo.id | Remove-Software -ForceCascade:$false
```
...
### EXAMPLE 2
```
Get-ManagedObject -Id $mo.id | Remove-Software
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/software_delete](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/software_delete)
