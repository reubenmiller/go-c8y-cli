...
id: Get-MicroserviceLogLevel
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/microservices_loglevels_get
schema: 2.0.0
slug: /docs/cli/psc8y/Microservices/get-microserviceloglevel
title: Get-MicroserviceLogLevel
---
...
## DESCRIPTION
Get configured log level for a package (incl.
...
### EXAMPLE 1
```
Get-MicroserviceLogLevel -Name my-microservice -LoggerName org.example
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/microservices_loglevels_get](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/microservices_loglevels_get)
