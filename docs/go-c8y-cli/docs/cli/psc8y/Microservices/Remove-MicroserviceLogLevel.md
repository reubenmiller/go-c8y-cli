...
id: Remove-MicroserviceLogLevel
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/microservices_loglevels_delete
schema: 2.0.0
slug: /docs/cli/psc8y/Microservices/remove-microserviceloglevel
title: Remove-MicroserviceLogLevel
---
...
### EXAMPLE 1
```
Remove-MicroserviceLogLevel -Name my-microservice -LoggerName org.example.microservice
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/microservices_loglevels_delete](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/microservices_loglevels_delete)
