...
id: Update-Microservice
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/microservices_update
schema: 2.0.0
slug: /docs/cli/psc8y/Microservices/update-microservice
...
## DESCRIPTION
Update details of an existing microservice, i.e.
availability, context path etc.

## EXAMPLES

### EXAMPLE 1
```
Update-Microservice -Id $App.id -Availability "MARKET"
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/microservices_update](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/microservices_update)
