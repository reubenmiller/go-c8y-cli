...
id: Set-MicroserviceLogLevel
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/microservices_loglevels_set
schema: 2.0.0
slug: /docs/cli/psc8y/Microservices/set-microserviceloglevel
title: Set-MicroserviceLogLevel
---
...
## DESCRIPTION
Set configured log level for a package (incl.
...
### EXAMPLE 1
```
Set-MicroserviceLogLevel -Name my-microservice -LoggerName org.example.microservice -LogLevel DEBUG
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/microservices_loglevels_set](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/microservices_loglevels_set)
