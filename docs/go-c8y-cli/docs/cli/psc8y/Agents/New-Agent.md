...
id: New-Agent
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/agents_create
schema: 2.0.0
slug: /docs/cli/psc8y/Agents/new-agent
title: New-Agent
---
...
## DESCRIPTION
Create an agent managed object.
An agent is a special device managed object with both the
...
### EXAMPLE 2
```
New-Agent -Name $AgentName -Data @{ myValue = @{ value1 = $true } }
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/agents_create](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/agents_create)
