...
id: Update-Agent
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/agents_update
schema: 2.0.0
slug: /docs/cli/psc8y/Agents/update-agent
title: Update-Agent
---
...
### EXAMPLE 1
```
Update-Agent -Id $agent.id -NewName "MyNewName"
```
...
### EXAMPLE 2
```
Update-Agent -Id $agent.name -NewName "MyNewName"
```
...
### EXAMPLE 3
```
Update-Agent -Id $agent.name -Data @{ "myValue" = @{ value1 = $true } }
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/agents_update](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/agents_update)
