...
id: Remove-SmartGroup
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/smartgroups_delete
schema: 2.0.0
slug: /docs/cli/psc8y/User Groups/remove-smartgroup
title: Remove-SmartGroup
---
...
## DESCRIPTION
Delete an existing smart group by id or name.
Deleting a smart group will not affect any of the devices related to it.

## EXAMPLES

### EXAMPLE 1
```
Remove-SmartGroup -Id $smartgroup.id
```
...
### EXAMPLE 2
```
Remove-SmartGroup -Id $smartgroup.name
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/smartgroups_delete](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/smartgroups_delete)
