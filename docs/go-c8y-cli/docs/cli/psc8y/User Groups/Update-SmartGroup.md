...
id: Update-SmartGroup
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/smartgroups_update
schema: 2.0.0
slug: /docs/cli/psc8y/User Groups/update-smartgroup
title: Update-SmartGroup
---
...
### EXAMPLE 1
```
Update-SmartGroup -Id $smartgroup.id -NewName "MyNewName"
```
...
### EXAMPLE 2
```
Update-SmartGroup -Id $smartgroup.name -NewName "MyNewName"
```
...
### EXAMPLE 3
```
Update-SmartGroup -Id $smartgroup.name -Data @{ "myValue" = @{ value1 = $true } }
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/smartgroups_update](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/smartgroups_update)
