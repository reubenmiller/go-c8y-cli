...
### EXAMPLE 2
```
Get-SmartGroupCollection -Name "$Name*"
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/smartgroups_list](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/smartgroups_list)
