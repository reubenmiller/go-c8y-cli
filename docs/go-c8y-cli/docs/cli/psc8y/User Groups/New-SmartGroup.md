...
id: New-SmartGroup
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/smartgroups_create
schema: 2.0.0
slug: /docs/cli/psc8y/User Groups/new-smartgroup
...
### EXAMPLE 1
```
New-SmartGroup -Name $smartgroupName
```
...
### EXAMPLE 2
```
New-SmartGroup -Name $smartgroupName -Query "type eq 'IS*' and has(c8y_Hardware.serialNumber)"
```
...
### EXAMPLE 3
```
New-SmartGroup -Name $smartgroupName -Query "type eq 'IS*'" -Invisible
```
...
### -Query
Smart group query.
Should be a valid inventory query.
i.e.
\"name eq 'myname' and has(myFragment)\"
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/smartgroups_create](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/smartgroups_create)
