...
id: Get-SmartGroup
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/smartgroups_get
schema: 2.0.0
slug: /docs/cli/psc8y/User Groups/get-smartgroup
...
### EXAMPLE 1
```
Get-SmartGroup -Id $smartgroup.id
```
...
### EXAMPLE 2
```
Get-SmartGroup -Id $smartgroup.name
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/smartgroups_get](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/smartgroups_get)
