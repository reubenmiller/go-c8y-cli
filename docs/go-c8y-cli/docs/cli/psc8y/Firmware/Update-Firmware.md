...
id: Update-Firmware
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/firmware_update
schema: 2.0.0
slug: /docs/cli/psc8y/Firmware/update-firmware
...
### EXAMPLE 1
```
Update-Firmware -Id $mo.id -Data @{ com_my_props = @{ value = 1 } }
```
...
### EXAMPLE 2
```
Get-ManagedObject -Id $mo.id | Update-Firmware -Data @{ com_my_props = @{ value = 1 } }
```
...
### -DeviceType
Device type filter.
Only allow firmware to be applied to devices of this type
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/firmware_update](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/firmware_update)
