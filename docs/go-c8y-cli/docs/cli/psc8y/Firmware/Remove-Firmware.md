...
id: Remove-Firmware
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/firmware_delete
schema: 2.0.0
slug: /docs/cli/psc8y/Firmware/remove-firmware
...
### EXAMPLE 2
```
Get-ManagedObject -Id $firmware.id | Remove-Firmware
```
...
### EXAMPLE 3
```
Get-ManagedObject -Id $firmware.id | Remove-Firmware -ForceCascade:$false
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/firmware_delete](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/firmware_delete)
