...
id: Invoke-CancelOperation
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/operations_cancel
schema: 2.0.0
slug: /docs/cli/psc8y/Operations/invoke-canceloperation
title: Invoke-CancelOperation
---
...
## DESCRIPTION
Cancel an operation.
This is a convenience command to set an operation to the FAILED status along with a sensible default failure reason.
...
### EXAMPLE 1
```
Invoke-CancelOperation -Id {{ NewOperation }}
```
...
### EXAMPLE 2
```
Get-OperationCollection -Device $Agent.id -Status PENDING | Invoke-CancelOperation -FailureReason "manually cancelled"
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/operations_cancel](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/operations_cancel)
