...
online version:
schema: 2.0.0
slug: /docs/cli/psc8y/Operations/watch-operation
...
### -Duration
Start date or date and time of operation occurrence.
(required)
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/operations_subscribe](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/operations_subscribe)
