...
id: Remove-OperationCollection
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/operations_deleteCollection
schema: 2.0.0
slug: /docs/cli/psc8y/Operations/remove-operationcollection
title: Remove-OperationCollection
---
...
### EXAMPLE 1
```
Remove-OperationCollection -Device "{{ randomdevice }}" -Status PENDING
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/operations_deleteCollection](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/operations_deleteCollection)
