...
id: Update-Operation
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/operations_update
schema: 2.0.0
slug: /docs/cli/psc8y/Operations/update-operation
...
## DESCRIPTION
Update an operation.
This is commonly used to change an operation's status.
For example the operation can be set to FAILED along with a failure reason.

## EXAMPLES

### EXAMPLE 1
```
Update-Operation -Id {{ NewOperation }} -Status EXECUTING
```
...
### EXAMPLE 2
```
Get-OperationCollection -Device $Agent.id -Status PENDING | Update-Operation -Status FAILED -FailureReason "manually cancelled"
```
...
Use when setting status to FAILED
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/operations_update](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/operations_update)
