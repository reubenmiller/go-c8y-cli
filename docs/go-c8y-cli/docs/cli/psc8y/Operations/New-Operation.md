...
id: New-Operation
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/operations_create
schema: 2.0.0
slug: /docs/cli/psc8y/Operations/new-operation
title: New-Operation
---
...
### EXAMPLE 1
```
New-Operation -Device $device.id -Description "Restart device" -Data @{ c8y_Restart = @{} }
```
...
### EXAMPLE 2
```
Get-Device $device.id | New-Operation -Description "Restart device" -Data @{ c8y_Restart = @{} }
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/operations_create](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/operations_create)
