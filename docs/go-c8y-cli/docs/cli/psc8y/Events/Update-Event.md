...
id: Update-Event
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/events_update
schema: 2.0.0
slug: /docs/cli/psc8y/Events/update-event
title: Update-Event
---
...
### EXAMPLE 1
```
Update-Event -Id $Event.id -Text "example text 1"
```
...
### EXAMPLE 2
```
Update-Event -Id $Event.id -Data @{ my_event = @{ active = $true } }
```
...
### EXAMPLE 3
```
Get-Event -Id $Event.id | Update-Event -Data @{ my_event = @{ active = $true } }
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/events_update](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/events_update)
