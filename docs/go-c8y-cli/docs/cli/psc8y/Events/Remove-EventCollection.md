...
id: Remove-EventCollection
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/events_deleteCollection
schema: 2.0.0
slug: /docs/cli/psc8y/Events/remove-eventcollection
title: Remove-EventCollection
---
...
### EXAMPLE 1
```
Remove-EventCollection -Type my_CustomType -DateFrom "-10d"
```
...
### EXAMPLE 2
```
Remove-EventCollection -Device "{{ randomdevice }}"
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/events_deleteCollection](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/events_deleteCollection)
