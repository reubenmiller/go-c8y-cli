...
id: New-Alarm
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/alarms_create
schema: 2.0.0
slug: /docs/cli/psc8y/Alarms/new-alarm
title: New-Alarm
---
...
### EXAMPLE 1
```
New-Alarm -Device $device.id -Type c8y_TestAlarm -Time "-0s" -Text "Test alarm" -Severity MAJOR
```
...
### EXAMPLE 2
```
Get-Device -Id $device.id | PSc8y\New-Alarm -Type c8y_TestAlarm -Time "-0s" -Text "Test alarm" -Severity MAJOR
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/alarms_create](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/alarms_create)
