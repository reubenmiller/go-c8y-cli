...
id: Update-Alarm
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/alarms_update
schema: 2.0.0
slug: /docs/cli/psc8y/Alarms/update-alarm
title: Update-Alarm
---
...
### EXAMPLE 1
```
Update-Alarm -Id $Alarm.id -Status ACKNOWLEDGED
```
...
### EXAMPLE 2
```
Get-Alarm -Id $Alarm.id | PSc8y\Update-Alarm -Status ACKNOWLEDGED
```
...
### EXAMPLE 3
```
Update-Alarm -Id $Alarm.id -Severity CRITICAL
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/alarms_update](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/alarms_update)
