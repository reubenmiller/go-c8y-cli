...
This section shows some examples of real world use-cases which I have personally needed at some point in time, or other people have are using in their Cumulocity journey.
...
You can inspect what the actual HTTP call looks like without sending it to Cumulocity. This helps you better understand the structure of the API, and you can also port the HTTP request to what ever language you want, and you have the exact call that you need.
