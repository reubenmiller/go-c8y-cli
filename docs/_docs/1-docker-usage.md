...
You can also specify the version that you want to try out by replacing `latest` with the version number, i.e. `1.3.0`.
...
# use a known version
docker pull ghcr.io/reubenmiller/c8y-zsh:1.3.0
```