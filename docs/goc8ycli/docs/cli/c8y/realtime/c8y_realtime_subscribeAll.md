---
category: realtime
title: c8y realtime subscribeAll
---
Subscribe to all realtime notifications
...
```
c8y realtime subscribeAll [flags]
```
...
```
      --actionTypes strings   Filter by realtime action types, i.e. CREATE,UPDATE,DELETE
