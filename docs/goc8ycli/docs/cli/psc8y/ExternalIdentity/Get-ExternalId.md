...
id: Get-ExternalId
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/identity_get
schema: 2.0.0
slug: /docs/cli/psc8y/ExternalIdentity/get-externalid
title: Get-ExternalId
---
...
## DESCRIPTION
Get an external identity object.
An external identify will include the reference to a single device managed object

## EXAMPLES

### EXAMPLE 1
```
Get-ExternalId -Type "my_SerialNumber" -Name "myserialnumber"
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/identity_get](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/identity_get)
