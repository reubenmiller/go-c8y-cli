...
id: Get-FirmwareVersionCollection
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/firmware_versions_list
schema: 2.0.0
slug: /docs/cli/psc8y/FirmwareVersion/get-firmwareversioncollection
title: Get-FirmwareVersionCollection
---
...
### EXAMPLE 1
```
Get-FirmwareVersionCollection -Firmware $firmware.id
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/firmware_versions_list](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/firmware_versions_list)
