...
id: Get-DeviceAvailability
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devices_availability_get
schema: 2.0.0
slug: /docs/cli/psc8y/Devices/get-deviceavailability
title: Get-DeviceAvailability
---
...
### EXAMPLE 1
```
Get-DeviceAvailability -Id $Device.id
```
...
### EXAMPLE 2
```
Get-DeviceAvailability -Id $Device.name
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devices_availability_get](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/devices_availability_get)
