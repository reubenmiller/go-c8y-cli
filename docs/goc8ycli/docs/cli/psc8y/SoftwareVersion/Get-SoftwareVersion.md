...
id: Get-SoftwareVersion
Module Name: PSc8y
online version: https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/software_versions_get
schema: 2.0.0
slug: /docs/cli/psc8y/SoftwareVersion/get-softwareversion
title: Get-SoftwareVersion
---
...
### EXAMPLE 1
```
Get-SoftwareVersion -Id $softwareVersion.id
```
...
### EXAMPLE 2
```
Get-ManagedObject -Id $softwareVersion.id | Get-SoftwareVersion
```
...
[https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/software_versions_get](https://reubenmiller.github.io/go-c8y-cli/docs/cli/c8y/software_versions_get)
